...
const deployWidget: FunctionDeclaration = {
  name: 'deploy_widget',
...
const createCustomWidget: FunctionDeclaration = {
...
const closeWidget: FunctionDeclaration = {
  name: 'close_widget',
...
const updateWidget: FunctionDeclaration = {
    name: 'update_widget',
...
const updateCode: FunctionDeclaration = {
    name: 'update_code',
...
const runCode: FunctionDeclaration = {
  name: 'run_code',
