    ...
    return (
      <>
        ...
        <DropdownMenuContent align="end" className="w-56 bg-card border-border">
          ...
          <DropdownMenuSeparator className="bg-border" />
          <DropdownMenuItem onClick={handleLogout} className="text-muted-foreground focus:bg-accent focus:text-foreground">
            Logout
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
          ...
          <div className="bg-card border border-border rounded-2xl shadow-2xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full flex items-center gap-3 p-4 bg-secondary hover:bg-green-500/10 border border-border hover:border-green-500 rounded-lg transition-all group"
              >
                ...
                <span className="text-foreground font-medium">Share on WhatsApp</span>
              </button>

              <button
                onClick={() => handleShare('twitter')}
                className="w-full flex items-center gap-3 p-4 bg-secondary hover:bg-blue-500/10 border border-border hover:border-blue-500 rounded-lg transition-all group"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-4 bg-secondary hover:bg-blue-600/10 border border-border hover:border-blue-600 rounded-lg transition-all group"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-4 bg-secondary hover:bg-blue-700/10 border border-border hover:border-blue-700 rounded-lg transition-all group"
              >
            ...
            <div className="pt-4 border-t border-border">
              ...
              >
                ...
                {copied ? (
                  ...
                  <Copy className="w-5 h-5 text-muted-foreground group-hover:text-foreground flex-shrink-0 ml-2" />
                )}
              </button>
            </div>
          </div>
