...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full w-full bg-art-bg text-white font-sans selection:bg-art-accent selection:text-white overflow-hidden rounded-xl">
